...
-- Reset sequence to start IDs from 1
DELETE FROM trips;
ALTER SEQUENCE trips_id_seq RESTART WITH 1;

-- Insert seed data
INSERT INTO trips (title, start_date, end_date, link, riding_days, difficulty) VALUES  
  ('Chasing Waterfalls', '2025-06-14', '2025-06-20', 'https://www.ishestar.is/packages/chasing-waterfalls-foss-comfort-tour/',5, 'intermediate'),
